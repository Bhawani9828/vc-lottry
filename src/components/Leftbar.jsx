...
import { FaTachometerAlt, FaUserPlus, FaProjectDiagram, FaCalendarAlt, FaFileAlt, FaChartBar, FaCog } from 'react-icons/fa';
...
function Leftbar({ isMenuOpen, toggleMenu }) {
  return (
    <>
      ...
      <div className={`leftbar h-screen bg-[#E4572E] duration-300 text-white flex flex-col ${isMenuOpen ? 'block' : 'hidden'} md:block`}>
